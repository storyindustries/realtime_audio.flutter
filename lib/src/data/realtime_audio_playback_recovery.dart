...
class RealtimeAudioPlaybackAccountingRepair {
  ...
  factory RealtimeAudioPlaybackAccountingRepair.fromMap(
    Map<String, dynamic> map,
  ) {
    return RealtimeAudioPlaybackAccountingRepair(
      repaired: map['repaired'] as bool? ?? false,
      reason: RealtimeAudioPlaybackAccountingRepairReason.fromWire(
        map['reason'] as String? ?? '',
      ),
      clock: RealtimeAudioPlaybackClock.fromJson(
        Map<String, dynamic>.from(map['clock'] as Map),
      ),
    );
  }
