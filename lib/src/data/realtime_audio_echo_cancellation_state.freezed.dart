...
@useResult
$Res call({
 bool requested, bool nativeEnabled,@JsonKey(unknownEnumValue: RealtimeAudioEchoCancellationMechanism.none) RealtimeAudioEchoCancellationMechanism mechanism, bool captureProvenLive
});
...
/// Create a copy of RealtimeAudioEchoCancellationState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? requested = null,Object? nativeEnabled = null,Object? mechanism = null,Object? captureProvenLive = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool requested,  bool nativeEnabled, @JsonKey(unknownEnumValue: RealtimeAudioEchoCancellationMechanism.none)  RealtimeAudioEchoCancellationMechanism mechanism,  bool captureProvenLive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RealtimeAudioEchoCancellationState() when $default != null:
return $default(_that.requested,_that.nativeEnabled,_that.mechanism,_that.captureProvenLive);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool requested,  bool nativeEnabled, @JsonKey(unknownEnumValue: RealtimeAudioEchoCancellationMechanism.none)  RealtimeAudioEchoCancellationMechanism mechanism,  bool captureProvenLive)  $default,) {final _that = this;
switch (_that) {
case _RealtimeAudioEchoCancellationState():
return $default(_that.requested,_that.nativeEnabled,_that.mechanism,_that.captureProvenLive);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool requested,  bool nativeEnabled, @JsonKey(unknownEnumValue: RealtimeAudioEchoCancellationMechanism.none)  RealtimeAudioEchoCancellationMechanism mechanism,  bool captureProvenLive)?  $default,) {final _that = this;
switch (_that) {
case _RealtimeAudioEchoCancellationState() when $default != null:
return $default(_that.requested,_that.nativeEnabled,_that.mechanism,_that.captureProvenLive);case _:
  return null;
...
class _RealtimeAudioEchoCancellationState extends RealtimeAudioEchoCancellationState {
  const _RealtimeAudioEchoCancellationState({this.requested = false, this.nativeEnabled = false, @JsonKey(unknownEnumValue: RealtimeAudioEchoCancellationMechanism.none) this.mechanism = RealtimeAudioEchoCancellationMechanism.none, this.captureProvenLive = false}): super._();
...
/// Create a copy of RealtimeAudioEchoCancellationState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? requested = null,Object? nativeEnabled = null,Object? mechanism = null,Object? captureProvenLive = null,}) {
